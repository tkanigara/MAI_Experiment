...
export default function AdsPeriodDetailPage({ client, period, platformCatalog, overview, onNavigate, onOpenPlatform, onUpdate, onSync, onEditGoals, onReviewObjectives, onMetricSettings, onSources }) {
