...
from agentic.tools.tools_list_ads_creative.retrieve_ig_data import retrieval_engagement_data
from agentic.utils.llm_output import get_llm_text
from agentic.utils.logger import node, console

def ig_engagement_agent(state: State):
    with node("Instagram Engagement Agent"):
        ...
        console.print("[green] Instagram engagement analysis result: [/green]")
