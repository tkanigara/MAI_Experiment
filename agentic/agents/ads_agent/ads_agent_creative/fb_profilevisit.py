...
def fb_profilevisit_agent(state: State) -> State:
    with node("Facebook Ads Profile Visist Analysis running"):
        ...
        facebook_result = FacebookMetricAnalysis(
            ...
            content_analysis_profilevisist = result["content_analysis_profilevisit"],
            placement_analysis_profilevisist= result["placement_analysis_profilevisit"],
            audience_demographic_profilevisit= result["audience_demographic_analysis_profilevisit"],
