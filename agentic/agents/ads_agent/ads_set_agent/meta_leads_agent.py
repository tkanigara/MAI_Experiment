...
from prompts.adset_prompts_list.meta_leads_prompt import SYSTEM_PROMPT

def meta_reach_agent(state: State):
    #retrieve Data
    overall_leads_data = """
    Data yang harus di retrive adalah nama client, periodnya dan data metric yang berisi gabungan dari semua adset objective leads
    """
    campaign_leads_data = """
    ...
    data = {
        "overall_leads_data":overall_leads_data,
        "campaign_leads_data":campaign_leads_data
    }
