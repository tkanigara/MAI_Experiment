...
from prompts.adset_prompts_list.meta_linkclicks_prompt import SYSTEM_PROMPT

def meta_reach_agent(state: State):
    #retrieve Data
    overall_linkclicks_data = """
    Data yang harus di retrive adalah nama client, periodnya dan data metric yang berisi gabungan dari semua adset objective linkclicks
    """
    campaign_linkclicks_data = """
    ...
    data = {
        "overall_linkclicks_data":overall_linkclicks_data,
        "campaign_linkclicks_data":campaign_linkclicks_data
    }
