...
from prompts.adset_prompts_list.meta_reach_prompt import SYSTEM_PROMPT

def meta_reach_agent(state: State):
    #retrieve Data
    overall_reach_data = """
    Data yang harus di retrive adalah nama client, periodnya dan data metric yang berisi gabungan dari semua adset objective reach
    """
    campaign_reach_data = """
    ...
    data = {
        "overall_reach_data":overall_reach_data,
        "campaign_reach_data":campaign_reach_data
    }
