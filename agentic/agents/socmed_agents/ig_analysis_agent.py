from workflows.socmed_workflow.state import State, instagram_result_analysis
from utils.llm_output import get_llm_text
from models.gemini import llm
from langchain_core.messages import HumanMessage, SystemMessage
from prompts.socmed_prompts_list.ig_analyst_prompt import KPI_PROMPT, SOCMED_OVERVIEW, FOLLOWERS_GROWTH, ENGAGEMENT_PERFORMANCE, INSTAGRAM_ANALYST, SYSTEM_PROMPT
from tools.tools_list_socmed.retrieva_ig_data import retrieve_kpi, retrieve_socmed_overview, retrieve_followers_growth, retrieve_engagement_performance, retrieve_content_by_bucket,retrieve_followers_growth_history, retrieve_engagement_performance_history, retrieve_competitor_analysis
